...
const AddItemForm = ({ navigation }) => {
  ...
  const handleSubmit = async () => {
    if (rating === 0) {
      Alert.alert("Error", "Por favor, selecciona una calificación para el ítem.");
      return;
    }
    ...
    if (isNaN(lat) || isNaN(lon) || lat < -90 || lat > 90 || lon < -180 || lon > 180) {
      Alert.alert("Error", "Por favor, ingresa coordenadas válidas. La latitud debe estar entre -90 y 90, y la longitud entre -180 y 180.");
      return;
    }
